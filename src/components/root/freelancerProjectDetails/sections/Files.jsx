...
const Files = ({ isProjectDataLoading }) => {
    ...
    const handleDownload = (record) => {
        fetch(record?.file_url)
            ...
            .then(blob => {
                fileDownload(blob, record?.filename);
            })
            .catch(error => {
    ...
    const columns = [
        ...
        },
        {
            title: '',
            key: 'action',
            render: (_, record) => <div className='flex justify-end sp1_marketplace_sm_text'>
                <button
                    onClick={() => {
        ...
        >
            <div className='files_page_wrapper'>
                ...
                <div className='files_page_content_wrapper'>
                    ...
                    {
                        isProjectDataLoading ? <AntdTableSkeleton columns={5} rows={5} /> : <Table
                            rowKey="id"
                            columns={columns}
