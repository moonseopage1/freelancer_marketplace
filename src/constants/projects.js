export const dummy_projects = [
  {
    ...
    project_id: 16297553,
    title:
      "Permanent Content Writer with SEO Knowledge Required (Monthly Basis) Quote Your Desired Monthly Payout",
    description:
    ...
    client_info: {
      user_id: 34567,
      avatar: "https://i.ibb.co/jHYks1p/client-image.png",
      name: "John Doe",
      location: {
        iso: "US",
...
export const project_proposals = [
  {
    ...
    freelancer_info: {
      user_id: 7384267,
      avatar: "https://i.ibb.co/MBQrkK0/user2.png",
      name: "Marry Doe",
      user_name: "marry_doe",
  ...
  },
  {
    ...
    freelancer_info: {
      user_id: 7384269,
      avatar: "https://i.ibb.co/n8shFcG/user1.png",
      name: "Abul Hossain",
      user_name: "abulh43",
